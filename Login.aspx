                    ...
                    <div class="login-fields">
                        ...
                        <div class="form-group username-field">
                            <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="Email">Email address<span>
                                <asp:RequiredFieldValidator ID="EmailRequired" runat="server" ControlToValidate="Email" ErrorMessage="Email is required." ToolTip="Email is required." Display="Dynamic" ValidationGroup="Login">*</asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="EmailRegularExpressionValidator" runat="server" ControlToValidate="Email" ErrorMessage="Invalid email format." ToolTip="Invalid email format." Display="Dynamic" ValidationGroup="Login" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$">*</asp:RegularExpressionValidator>
                            </span></asp:Label>
                        ...
                        <div class="form-group password-field">
                            ...
                            <asp:Label ID="PasswordLabel" runat="server" AssociatedControlID="Password">Password<span>
                                ...
                                <asp:RegularExpressionValidator ID="PasswordRegularExpression" runat="server" ControlToValidate="Password" ErrorMessage="Password must be at least 8 characters long, contain at least one uppercase letter, one lowercase letter, one digit, and one symbol." ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" ValidationGroup="Login">*</asp:RegularExpressionValidator>
                            </span></asp:Label>
